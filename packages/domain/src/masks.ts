import type { DisplaySegment } from "./index.js";
...
const BUILTIN_MASK_TEMPLATES: readonly BuiltinMaskTemplate[] = [
  ...
  {
    id: "mask-codex-skills-catalog",
    name: "Codex Skills Catalog",
    description: "Collapses the injected Codex skills catalog that precedes a user request.",
    match_type: "regex",
    match_pattern: "## Skills\\nA skill is a set of local instructions[\\s\\S]*?</INSTRUCTIONS>",
    action: "collapse",
    collapse_label: "Skills Instructions",
    priority: 4,
    applies_to: ["user_message", "system_message"],
    is_builtin: true,
    is_active: true,
  ...
  {
    id: "mask-skills-instructions-block",
    name: "Skills Instructions Block",
    description: "Collapses structured injected skills instructions.",
    match_type: "regex",
    match_pattern: "<skills_instructions>[\\s\\S]*?</skills_instructions>",
    action: "collapse",
    collapse_label: "Skills Instructions",
    priority: 5,
    applies_to: ["user_message", "system_message"],
  ...
  {
    id: "mask-permissions-instructions-block",
    name: "Permissions Instructions Block",
    description: "Collapses structured injected permission instructions.",
    match_type: "regex",
    match_pattern: "<permissions instructions>[\\s\\S]*?</permissions instructions>",
    action: "collapse",
    collapse_label: "Permissions Instructions",
    priority: 6,
    applies_to: ["user_message", "system_message"],
    is_builtin: true,
    is_active: true,
  ...
  {
    id: "mask-collaboration-mode-block",
    name: "Collaboration Mode Block",
    description: "Collapses structured injected collaboration-mode instructions.",
    match_type: "regex",
    match_pattern: "<collaboration_mode>[\\s\\S]*?</collaboration_mode>",
    action: "collapse",
    collapse_label: "Collaboration Mode",
    priority: 7,
    applies_to: ["user_message", "system_message"],
    is_builtin: true,
    is_active: true,
